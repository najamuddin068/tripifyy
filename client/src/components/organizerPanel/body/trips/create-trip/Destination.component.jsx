...
export default class Destination extends Component {
  ...
  render() {
    ...
    const {title, desc, designation, tripType, numberOfPeople, numberOfDays, departureDate} = values
    const destinationData = {title, desc, designation, tripType, numberOfPeople, numberOfDays, departureDate}
    return (
