...
import Spinner from "../myfeed/Spinner.component";
...
class Post extends Component {
  ...
  onDelete = (id) => {
    ...
    window.location = "/organizer/myfeed";
  };
  render() {
    ...
    return (
      <div>
          ...
          <MDBCardHeader className="border-0  rounded d-flex justify-content-between">
            ...
            <div className="d-flex flex-column justify-content-between align-items-end">
              ...
              <div className="mt-0 pt-0 grey-text">
                {post.post.organizer === auth.organizer.id ? (
                  <Link
                    className="red-text"
        ...
        {post.post.comments? <CommentList comments={post.post.comments} postId={post.post._id}/> : null}
