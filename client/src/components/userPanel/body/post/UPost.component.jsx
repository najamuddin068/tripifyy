...
import UCommentForm from "./UCommentForm.component";
import UCommentList from "./UCommentList.component";
      ...
      <div>
        <MDBContainer className="getPost-container">
          ...
          <MDBMedia className="bg-white m-3">
            <MDBMedia body>
              <div className='feed-get-text1 '>{post.post.text}</div></MDBMedia>
          </MDBMedia>
          <div
          ...
          <UCommentForm postId={post.post._id}/>
          </div>

        </MDBContainer>
        {post.post.comments? <UCommentList comments={post.post.comments} postId={post.post._id}/> : null}
