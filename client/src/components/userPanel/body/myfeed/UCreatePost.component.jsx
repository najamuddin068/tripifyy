...
import './UCreatePost.styles.scss'
import { connect } from 'react-redux';
import {addPost} from '../../../../actions/postActions'
import PropTypes from 'prop-types'
import classnames from 'classnames'

class UCreatePost extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <div className='create-post-container-organizer'>
                   ...
                   <br/>
                    <MDBInput 
                        ...
                        <MDBRow> <MDBCol>
                        {errors.text && (<div className='validateError'>{errors.text}</div>)}
                    <MDBInput 
                        type='textarea' 
                        label="Write Post" 
                         outline
                    ...
                    <MDBBtn type='submit' onClick={this.onSubmit} style={{margin:'2rem 0px', width:'100%',  }}>Create Post</MDBBtn>
                   </form>
                   </MDBCollapse>
...
export default connect(mapStateToProps, {addPost})(UCreatePost);